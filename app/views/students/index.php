...
<!-- Header Start -->
    <header class="bg-blue-900 text-white">
        <div class="flex items-center justify-between container mx-auto p-4">
            ...
            <a class="py-2 px-4 bg-white text-blue-900 font-bold rounded-lg" href="/students/create">+ Tambah Siswa</a>
        </div>
                ...
                <table class="w-full">
                    <thead class="bg-gray-300">
                        <tr>
                            ...
                            <th class="px-4 py-2 text-left">No Telephone</th>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td class="px-4 py-2 text-left">Nichole</td>
                            <td class="px-4 py-2 text-left">XI TKJ 1</td>
                            <td class="px-4 py-2 text-left"> 7765</td>
                            <td class="px-4 py-2 text-left">08987655333</td>
                            <td class="px-4 py-2 ">
                                <div class="flex justify-center items-center gap-4">
                                    <a href="" class="text-green-300">Detail</a>
                                    <a href="" class="text-yellow-300">Edit</a>
                                    <a href="" class="text-red-300">Hapus</a>
                                </div>
                            </td>
                        </tr>
                    </tbody>
